...
Checkpoint:
`/srv/nvme-data/containers/projects/qwen27b/models/Qwen3.6-27B-Q3_K_S.gguf`

## Reproduction

`bench/gguf_9b_bench.py` with `FNI8_SPEC_DECODE=1`, `FNI8_MAX_LEN=512`,
`FNI8_NEW_TOKENS=32`, and `PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True`.
