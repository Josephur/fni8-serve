...
Run in the fni8-serve test image on ONE FREE gpu (NEVER GPU4 — the live server):
...
def main():
    ...
    print(f"\n### fni8-serve spec-decode CONTROLLED bench — {regime}")
    print(f"### model={os.path.basename(FNI8)}  max_new={MAXTOK}  spec_k={SPEC_K}  "
