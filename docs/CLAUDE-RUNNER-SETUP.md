...
for r in fni8 fni8-serve ComfyUI-fni8; do
...
./config.sh --url https://github.com/jajmangold/fni8 --token <RUNNER_TOKEN> \
            --labels self-hosted,volta-gpu,linux --name fni8-volta-1
...
`fni8-serve` and `ComfyUI-fni8` are public. A self-hosted runner on a public repo is a
