...
Measures per-boundary latency of fni8.transport send/recv under raw-fp16
...
from fni8serve.dist import recv, send
from fni8serve.dist.codec_quality import verify_boundary_fidelity
from fni8serve.dist.transfer_model import estimate_boundary_ms
