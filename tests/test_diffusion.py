...
non-autoregressively through the engine. Needs CUDA + fni8 kernels."""
import pytest
import torch

pytest.importorskip("fni8")

from fni8serve.engine import LLMEngine, SamplingParams, DiffusionDecodeStrategy
from fni8serve.models import ModelConfig, build_model, is_supported, list_models

CUDA = torch.cuda.is_available()
pytestmark = pytest.mark.skipif(not CUDA, reason="diffusion model needs CUDA fni8 kernels")
