...
from fni8serve.loader import load_training_checkpoint, save_training_checkpoint
from fni8serve.train.loop import TrainableLM
...
def test_save_training_checkpoint_roundtrip(tmp_path):
    ...
    ckpt_path = str(tmp_path / "training.fni8")
...
def test_save_training_checkpoint_meta_preserved(tmp_path):
    ...
    ckpt_path = str(tmp_path / "meta.fni8")
