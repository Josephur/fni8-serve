...
All tests need CUDA + fni8 (same as test_paged_engine.py).
"""
...
from fni8serve.engine import PagedKVCache
from fni8serve.engine.kv_cache import EvictionConfig, KVEviction

CUDA = torch.cuda.is_available()
pytestmark = pytest.mark.skipif(not CUDA, reason="needs CUDA + fni8 paged kernels")
...
class TestEvictionWithDecode:
    ...
    def test_decode_after_eviction_produces_valid_logits(self):
        ...
        from fni8serve.models import ForwardContext, ModelConfig, build_model
