...
an EOS), not a real HF tokenizer/model -- same "no CUDA/fni8/model weights" spirit as
...
from fni8serve.structured import GrammarCompilerCache, GrammarLogitsProcessor  # noqa: E402
