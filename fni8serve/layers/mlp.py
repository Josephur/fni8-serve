...
Both projections run on the fni8 dp4a GEMM (`LinearW8A8`, W8A8 or W4A8 from the
`.fni8` weight). gate_proj and up_proj are stored MERGED into one `gate_up` weight
