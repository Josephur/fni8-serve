...
See also: epic #60 (scale-out), #84 (PP), and fni8 transport-compression.md.
"""
...
def validate_parallel_config(serve_cfg) -> tuple[list[str], list[str]]:
    ...
    if tp != 1:
        errors.append(
            ...
            "and/or expert_parallel_size instead — see fni8 transport-compression.md."
        )
    ...
    if pp > _MAX_PP_DEPTH:
        warnings_list.append(
            ...
            f"See docs/parallelism-doctrine.md and fni8 transport-compression.md."
        )
